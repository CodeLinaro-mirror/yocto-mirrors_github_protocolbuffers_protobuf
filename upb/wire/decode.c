...
static const char* _upb_Decoder_ReadString(upb_Decoder* d, const char* ptr,
  ...
  if (validate_utf8) _upb_Decoder_VerifyUtf8(d, str->data, size);
  return ptr;
}
  ...
  switch (op) {
    ...
    case kUpb_DecodeOp_String: {
      ...
      upb_StringView* str = (upb_StringView*)upb_Array_MutableDataPtr(arr) +
                            arr->UPB_PRIVATE(size);
      ptr = _upb_Decoder_ReadString(d, ptr, val->size, str, true);
      arr->UPB_PRIVATE(size)++;
      return ptr;
    }
    case kUpb_DecodeOp_Bytes: {
      ...
      upb_StringView* str = (upb_StringView*)upb_Array_MutableDataPtr(arr) +
                            arr->UPB_PRIVATE(size);
      ptr = _upb_Decoder_ReadString(d, ptr, val->size, str, false);
      arr->UPB_PRIVATE(size)++;
      return ptr;
    }
...
static const char* _upb_Decoder_DecodeToSubMessage(
  ...
  switch (op) {
    ...
    case kUpb_DecodeOp_String:
      return _upb_Decoder_ReadString(d, ptr, val->size, mem, true);
    case kUpb_DecodeOp_Bytes:
      return _upb_Decoder_ReadString(d, ptr, val->size, mem, false);
    case kUpb_DecodeOp_Scalar8Byte:
      memcpy(mem, val, 8);
      break;
    case kUpb_DecodeOp_Scalar4Byte:
