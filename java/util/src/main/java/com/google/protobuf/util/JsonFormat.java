...
import com.google.protobuf.pb.enumvalue.JsonEnumValueOptions;
      ...
      if (result == null) {
        ...
        for (EnumValueDescriptor ev : enumDescriptor.getValues()) {
          if (ev.getOptions().hasExtension(JsonEnumvalueOptionsProto.json)) {
            JsonEnumValueOptions customOptions =
                ev.getOptions().getExtension(JsonEnumvalueOptionsProto.json);
