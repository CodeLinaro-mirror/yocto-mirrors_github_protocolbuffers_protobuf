...
public abstract class CodedInputStream {
  ...
  /**
   * Experiment to enable new varint reading. Only for Search to use for evaluation. Will be removed
  ...
  private abstract static class ArrayDecoder extends CodedInputStream {
    ...
    /**
     * Ignore up to 5 more bytes of a varint. If the varint continues to a 6th byte then throw.
     *
     * <p>This is a separate method to try to make the JIT correctly lean towards treating this path
     * as cold since 6-10 byte varint32s are rare.
     *
     * @return final pos
     */
    // @SuppressWarnings("IdentityBinaryExpression") // tempPos++ has side effects
    // private static int readRawVarint32NewFastIgnoreExtraBytes(byte[] buffer, int tempPos)
    //     throws IOException {
    //   if (
    //   return tempPos;
    // }
