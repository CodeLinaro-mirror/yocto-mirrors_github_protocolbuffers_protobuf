  ...
  public static final class FieldDescriptor extends GenericDescriptor
    ...
    public Type getType() {
      ...
      if (type == Type.MESSAGE
          && !(typeName != null && ((Descriptor) typeName).toProto().getOptions().getMapEntry())
    ...
    public EnumDescriptor getEnumType() {
      ...
      return (EnumDescriptor) typeName;
    }
    ...
    private GenericDescriptor typeName;
    ...
    private void crossLink() throws DescriptorValidationException {
      ...
      if (proto.hasTypeName()) {
        ...
        if (type.getJavaType() == JavaType.MESSAGE) {
          ...
          typeName = (Descriptor) typeDescriptor;
          ...
          typeName = (EnumDescriptor) typeDescriptor;
        } else {
