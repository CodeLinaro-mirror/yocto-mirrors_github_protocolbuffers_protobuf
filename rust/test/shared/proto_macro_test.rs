...
//     let msg2 = proto!(NestedTestAllTypes { payload: TestAllTypes {
// optional_int32: 2 } });     let msg = proto!(NestedTestAllTypes {
//         child: NestedTestAllTypes {
//             repeated_child: [
//                 NestedTestAllTypes { payload: TestAllTypes { optional_int32:
// 1 } },                 msg2,
//                 NestedTestAllTypes { payload: TestAllTypes { optional_int32:
// 3 } }             ]
//         }
...
//     assert_that!(msg.child().repeated_child().get(0).unwrap().payload().
// optional_int32(), eq(1));     assert_that!(msg.child().repeated_child().
// get(1).unwrap().payload().optional_int32(), eq(2));     assert_that!(msg.
// child().repeated_child().get(2).unwrap().payload().optional_int32(), eq(3));
// }
