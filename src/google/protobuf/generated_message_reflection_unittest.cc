...
TEST(GeneratedMessageReflection, IsDescendantUnparsedLazyField) {
  proto2_unittest::TestAllTypes msg;

  {
    proto2_unittest::TestAllTypes src;
    src.mutable_optional_lazy_message()->set_bb(123);
    auto serialized = src.SerializeAsString();
...
TEST(GeneratedMessageReflection, IsDescendantUnparsedLazyExtension) {
  proto2_unittest::TestAllExtensions msg;

  {
    proto2_unittest::TestAllExtensions src;
    src.MutableExtension(unittest::optional_lazy_message_extension)
        ->set_bb(123);
    auto serialized = src.SerializeAsString();
    ASSERT_TRUE(msg.ParseFromString(serialized));
  }
  ...
  proto2_unittest::TestAllExtensions msg2;
  EXPECT_FALSE(IsDescendant(msg, msg2));
