...
enum FeatureSet_EnforceNamingStyle : int {
  ...
  FeatureSet_EnforceNamingStyle_LEGACY_STYLE = 2,
};
...
inline const std::string& FeatureSet_EnforceNamingStyle_Name(FeatureSet_EnforceNamingStyle value) {
  return ::google::protobuf::internal::NameOfDenseEnum<FeatureSet_EnforceNamingStyle_descriptor,
                                                 0, 2>(
      static_cast<int>(value));
}
inline bool FeatureSet_EnforceNamingStyle_Parse(
  ...
  return ::google::protobuf::internal::ParseNamedEnum<FeatureSet_EnforceNamingStyle>(
      FeatureSet_EnforceNamingStyle_descriptor(), name, value);
}
enum GeneratedCodeInfo_Annotation_Semantic : int {
...
/* @@protoc_insertion_point(class_definition:google.protobuf.FeatureSet) */ {
 ...
 public:
  ...
  static constexpr EnforceNamingStyle LEGACY_STYLE = FeatureSet_EnforceNamingStyle_LEGACY_STYLE;
