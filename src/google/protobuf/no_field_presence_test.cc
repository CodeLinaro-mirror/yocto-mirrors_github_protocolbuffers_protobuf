...
TEST(NoFieldPresenceTest, ExtraZeroesInWireFormatParseTest) {
  ...
  dest.ParseFromString(wire);
  EXPECT_EQ(0, dest.c());
}

TEST(NoFieldPresenceTest, ExtraZeroesInWireFormatMergeTest) {
...
TEST(NoFieldPresenceTest, ExtraZeroesInWireFormatLastWins) {
