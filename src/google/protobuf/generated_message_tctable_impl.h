...
#define PROTOBUF_TC_PARSE_FUNCTION_LIST                           \
  ...
  PROTOBUF_TC_PARSE_FUNCTION_LIST_REPEATED(FastSc)                \
...
class PROTOBUF_EXPORT TcParser final {
 public:
  ...
  PROTOBUF_NOINLINE PROTOBUF_CC static const char* FastBcR2(
      PROTOBUF_TC_PARAM_DECL);
  PROTOBUF_NOINLINE PROTOBUF_CC static const char* FastScR1(
      PROTOBUF_TC_PARAM_DECL);
  PROTOBUF_NOINLINE PROTOBUF_CC static const char* FastScR2(
      PROTOBUF_TC_PARAM_DECL);
