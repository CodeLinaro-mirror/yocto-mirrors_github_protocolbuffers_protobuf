...
[[nodiscard]] inline bool CppFeatures_RepeatedType_IsValid(int value) {
  return 0 <= value && value <= 2;
}
inline constexpr int CppFeatures_RepeatedType_RepeatedType_ARRAYSIZE = 2 + 1;
[[nodiscard]] PROTOBUF_EXPORT const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL
CppFeatures_RepeatedType_descriptor();
[[nodiscard]] inline auto ProtobufInternalGetEnumDescriptor(CppFeatures_RepeatedType) {
  return CppFeatures_RepeatedType_descriptor();
}
template <typename T>
[[nodiscard]] const ::std::string& CppFeatures_RepeatedType_Name(T value) {
...
/* @@protoc_insertion_point(class_definition:pb.CppFeatures) */ {
 ...
 public:
  ...
  [[nodiscard]] static inline bool RepeatedType_IsValid(int value) {
  ...
  template <typename T>
  [[nodiscard]] static inline const ::std::string& RepeatedType_Name(T value) {
    return CppFeatures_RepeatedType_Name(value);
  }
  [[nodiscard]] static inline bool RepeatedType_Parse(
