...
#undef desc
 ...
 private:
  ...
  struct Extension {
    ...
    struct DescriptorOrPrototype {
     ...
     private:
      ...
      // Requires: IsExtensionInfo() is true.
    ...
    DescriptorOrPrototype desc_or_proto;
  };
  ...
  // Inserts a new (key, Extension) into the ExtensionSet (and returns true),
  // or finds the already-existing Extension for that key (returns false). The
  // Extension* will point to the new-or-found Extension.
  ...
  bool MaybeNewExtension(int number, const FieldDescriptor* descriptor,
                         Extension** result);
  bool MaybeNewExtension(int number,
                         Extension::DescriptorOrPrototype desc_or_proto,
                         Extension** result);
