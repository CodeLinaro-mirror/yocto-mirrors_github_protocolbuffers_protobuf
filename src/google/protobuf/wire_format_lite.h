...
#define GOOGLE_PROTOBUF_WIRE_FORMAT_MAKE_TAG(FIELD_NUMBER, TYPE) \
  ...
  static size_t Int32SizeWithPackedTagSize(const RepeatedField<int32_t>& value,
                                           int tag_size,
                                           internal::CachedSize& cached_size);
  static size_t Int64SizeWithPackedTagSize(const RepeatedField<int64_t>& value,
                                           int tag_size,
                                           internal::CachedSize& cached_size);
  ...
  static size_t UInt64SizeWithPackedTagSize(
      ...
      internal::CachedSize& cached_size);
  static size_t SInt32SizeWithPackedTagSize(const RepeatedField<int32_t>& value,
                                            int tag_size,
                                            internal::CachedSize& cached_size);
  static size_t SInt64SizeWithPackedTagSize(const RepeatedField<int64_t>& value,
                                            int tag_size,
                                            internal::CachedSize& cached_size);
  static size_t EnumSizeWithPackedTagSize(const RepeatedField<int>& value,
                                          int tag_size,
                                          internal::CachedSize& cached_size);
