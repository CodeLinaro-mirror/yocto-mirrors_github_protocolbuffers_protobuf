...
class Wire {
 ...
 private:
  ...
  struct TypeCheckImpl {};

  template <typename... Args>
  struct TypeCheckImpl<Wire, Args...> : std::true_type {};
  template <typename... Args>
  struct TypeCheckImpl<absl::string_view, Args...> : std::true_type {};
  template <typename... Args>
  struct TypeCheckImpl<std::string, Args...> : std::true_type {};
  template <typename... Args>
  struct TypeCheckImpl<const char*, Args...> : std::true_type {};

  template <typename... Args>
  static std::string TypeCheckedCat(Args&&... args) {
    static_assert(TypeCheckImpl<std::decay_t<Args>...>::value);
