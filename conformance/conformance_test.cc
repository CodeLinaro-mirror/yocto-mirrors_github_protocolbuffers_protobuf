...
bool ConformanceTestSuite::RunSuite(ConformanceTestRunner* runner,
  ...
  if (!CheckSetEmpty(
          ...
          absl::StrCat(
              "These test names (either expanded from wildcard(s) or direct "
              "matches) were listed in the failure list, but they didn't match "
              "any actual test name.  Remove their match from the "
