...
void WriteRepeatedMessageAccessor(const protobuf::Descriptor* message,
  ...
  output(
      ...
      MessageWithoutAddendum(field));
  /*

bazel-out/k8-fastbuild/bin/video/youtube/utils/elements/proto/annotations.upb.proto.cc:203:34:
error: no member named 'elements_VersionCompatibilityRange' in namespace
'youtube' 203 |     elements[size] =
(::youtube::elements_VersionCompatibilityRange*)
