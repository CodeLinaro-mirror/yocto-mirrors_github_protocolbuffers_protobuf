...
from google.protobuf.internal import well_known_types_pb2
...
class TimeUtilTest(TimeUtilTestBase):
  ...
  def testTimestampAssignment(self, date_parts, tzinfo):
    original_datetime = datetime.datetime(*date_parts, tzinfo=tzinfo)  # pylint:disable=g-tzinfo-datetime
    msg = well_known_types_pb2.WKTMessage()
  ...
  def testTimestampCreation(self, date_parts, tzinfo):
    original_datetime = datetime.datetime(*date_parts, tzinfo=tzinfo)  # pylint:disable=g-tzinfo-datetime
    msg = well_known_types_pb2.WKTMessage(optional_timestamp=original_datetime)
    self.assertEqual(7200, msg.optional_timestamp.seconds)
    self.assertEqual(0, msg.optional_timestamp.nanos)

    msg2 = well_known_types_pb2.WKTMessage(
  ...
  def testTimestampAdd(self, old_time, time_delta, expected_sec, expected_nano):
    ...
    # Timestamp + timedelta
    new_msg1 = well_known_types_pb2.WKTMessage()
    ...
    # timedelta + Timestamp
    new_msg2 = well_known_types_pb2.WKTMessage()
    ...
    new_msg3 = well_known_types_pb2.WKTMessage()
  ...
  def testTimestampSub(self, old_time, time_delta, expected_sec, expected_nano):
    ...
    result_msg = well_known_types_pb2.WKTMessage()
  ...
  def testInvalidTimestamp(self):
    ...
    with self.assertRaises(AttributeError):
      msg2 = well_known_types_pb2.WKTMessage(optional_timestamp=1)
  ...
  def testInvalidDuration(self):
    ...
    with self.assertRaises(AttributeError):
      msg2 = well_known_types_pb2.WKTMessage(optional_duration=1)
  ...
  def testDurationAssignment(self, microseconds, expected_sec, expected_nano):
    message = well_known_types_pb2.WKTMessage()
  ...
  def testDurationAdd(self, old_time, time_delta, expected_sec, expected_nano):
    ...
    # Duration + datetime
    msg1 = well_known_types_pb2.WKTMessage()
    ...
    # Duration + Timestamp
    msg3 = well_known_types_pb2.WKTMessage()
...
class StructTest(unittest.TestCase):
  ...
  def testSpecialStructConstruct(self):
    dictionary = {'key1': 6.0}
    msg = well_known_types_pb2.WKTMessage(optional_struct=dictionary)
    self.assertEqual(msg.optional_struct, dictionary)

    dictionary2 = {'fields': 7.0}
    msg2 = well_known_types_pb2.WKTMessage(optional_struct=dictionary2)
    ...
    msg3 = well_known_types_pb2.WKTMessage(optional_struct=dictionary3)
...
class AnyTest(unittest.TestCase):
  ...
  def testAnyMessage(self):
    ...
    msg = well_known_types_pb2.TestAny()
  ...
  def testMessageName(self):
    # Creates and sets message.
    submessage = well_known_types_pb2.TestAny()
  ...
  def testPackWithCustomTypeUrl(self):
    ...
    unpacked_message = well_known_types_pb2.TestAny()
